  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p><a data-toggle="modal" class="btn btn-lg btn-success" href="#instructor" role="button">Brought To You By: SP creations </a></p>
      </div>

      <!-- Site footer -->
      <footer class="footer">
        <p align="center">PAYROLL MANAGEMENT SYSTEM</p>
        <p align="center">Brought To You By<a target="_blank" href="http://vvce.ac.in"> SP creations</a></p>
      </footer>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              <div align="center">
                <a href="http://freeproject24.com/" target="_blank" title="freeproject24"><big><b>SP creations</b></big></a>
              </div>
            </div>
          </div>
        </div>
